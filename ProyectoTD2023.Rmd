...
A <- readBin(ficheroB, "integer", n = file.info(ficheroB)$size, endian = "little")
HR1 <- A[seq(1, length(A), 9)]
HR2 <- A[seq(2, length(A), 9)]
MHR <- A[seq(3, length(A), 9)]
TOCO <- A[seq(4, length(A), 9)]
MSpO2 <- A[seq(5, length(A), 9)]
VCP <- A[seq(6, length(A), 9)]
